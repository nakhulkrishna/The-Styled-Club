...
class ManBannerCarouselSlider extends StatelessWidget {
  const ManBannerCarouselSlider({
    super.key,
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MenBannerCubit, MenBannerState>(
      builder: (context, state) {
        if (state is MenBannerLoading) {
        ...
        } else if (state is MenBannerLoaded) {
        ...
        } else if (state is MenBannerError) {
          return CarouselSlider(
            options: CarouselOptions(
              height: screenHeight * 0.6,
              autoPlay: true,
